...
public class GenerateFlipkartShortLinks {
	...
	private static final String COOKIE = System.getenv("FlipkartCookie") != null ? System.getenv("FlipkartCookie")
	...
	private static final String AMAZON_COOKIE = System.getenv("AmazonCookie") != null ? System.getenv("AmazonCookie")
